        ...
        <section id="contact" className="py-20 md:py-32 px-4 bg-secondary/50 relative overflow-hidden">
            ...
            <div className="absolute inset-0 z-0">
                <video
                    ...
                    muted
                    playsInline
                    className="h-full w-full object-cover opacity-20 dark:opacity-10 grayscale"
                >
                    <source src="/assets/videos/cta-loop.mp4" type="video/mp4" />
                    {/* Fallback for when video fails or is not found */}
                </video>
