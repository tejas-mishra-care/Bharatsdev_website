      ...
      <section className="py-20 bg-background relative overflow-hidden">
        ...
        <div className="container mx-auto relative z-10">
          ...
          <div className="relative max-w-2xl mx-auto">
            {/* Scrollytelling Visual Element */}
            <motion.div
              className="absolute -right-24 top-0 hidden lg:block"
              style={{
                y: 0, // In real implementation, this would be tied to scroll
              }}
            >
              <div className="w-32 h-32 bg-primary/10 rounded-full blur-3xl animate-pulse" />
              <div className="w-16 h-16 border-2 border-primary/20 rounded-full absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 animate-spin-slow" />
            </motion.div>
            <motion.div
