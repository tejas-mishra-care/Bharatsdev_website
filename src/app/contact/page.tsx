...
export default function ContactPage() {
  ...
  const submitForm = (e: React.FormEvent) => {
    ...
    startTransition(async () => {
      ...
      fd.append("projectType", formData.service);
      ...
      const result = await handleContactForm({ message: "" }, fd);
      if (!result.errors) {
        setSubmitted(true);
      } else {
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-start">
          ...
          >
            ...
            <p className="text-xl text-zinc-400 font-sans mb-12 max-w-md">
              We protect our engineers' time. Fill out the project scope to see
              if we are a mutual fit.
            </p>
          ...
          <motion.div
            ...
            animate={{ opacity: 1, x: 0 }}
            transition={springTransition}
            className="bg-[#0A0A0A] border border-[#2A2A2E] rounded-[2rem] p-8 md:p-12 shadow-2xl relative overflow-hidden"
          >
            ...
            {submitted ? (
              ...
              >
                ...
                <p className="text-zinc-400">
                  Shristi will review your scope and contact you within 24
                  hours.
                </p>
              </motion.div>
            ) : (
                ...
                <AnimatePresence mode="wait">
                  ...
                  {step === 3 && (
                    ...
                    >
                      ...
                      {["$5k - $10k", "$10k - $25k", "$25k+ Enterprise"].map(
                        (opt) => (
                          <div
                            key={opt}
                            onClick={() =>
                  ...
                  {step === 4 && (
                    ...
                    >
                      ...
                      <input
                        ...
                        className="w-full bg-black border border-[#2A2A2E] rounded-xl p-4 text-white focus:outline-none focus:border-[#2563EB]"
                      />
                      <input
                        type="email"
                      ...
                      <textarea
                        ...
                        className="w-full bg-black border border-[#2A2A2E] rounded-xl p-4 text-white min-h-[120px] resize-none focus:outline-none focus:border-[#2563EB]"
                      />
                    </motion.div>
                  )}
                </AnimatePresence>
                ...
                <div className="flex items-center justify-between mt-10 pt-8 border-t border-[#2A2A2E]">
                  ...
                  {step < 4 ? (
                    ...
                    <Button
                      type="submit"
                      disabled={isPending}
                      className="bg-[#2563EB] text-white hover:bg-[#1D4ED8] font-bold px-8 shadow-[0_0_20px_rgba(37,99,235,0.3)]"
                    >
                      {isPending ? (
                        <>
                          Submitting{" "}
