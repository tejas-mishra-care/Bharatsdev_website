        ...
        <article className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none mx-auto text-muted-foreground leading-relaxed">
             ...
             <ul className="list-disc pl-6 space-y-2 my-6">
                ...
                <li><strong className="font-semibold text-foreground">Day 2 (24-48 Hours):</strong> Frontend and backend were integrated. Rigorous end-to-end testing was conducted by our Head of Project Management, Shristi Mishra. The final system was deployed, and full source code and documentation were handed over.</li>
             </ul>
